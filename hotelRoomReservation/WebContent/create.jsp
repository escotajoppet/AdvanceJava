...
<%
	err = "";
	if(request.getParameter("button").equals("createSubmit")) {	
		try{
			...
			if(checkOut1 < checkIn1) {
				...
				int code = link.createResCustomer();
				link.createResGeneral();
				link.createResBalance();
				err = "Reservation successfully reserved.";				
			}			
...
<body>
	<div id="main">
		<div id="form1">
			<div id="title"><p>Create Reservation</p></div>
