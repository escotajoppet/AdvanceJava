...
<%
	hotelReservation.clearPromoInfomation();
	hotelReservation.setPromoInformation();
%>
...
<body>
	<center>
		...
		<%
			for(int i = 0; i<hotelReservation.getViewPromoName().size(); i++){
		%>
			<table border="2" cellpadding="5">
				<tr>
					<th><%=hotelReservation.getViewPromoName().get(i) %></th>
				</tr>
				<tr>
					<td><%=hotelReservation.getViewPromoDescription().get(i) %></td>
				</tr>
			</table>
