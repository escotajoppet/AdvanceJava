...
<%
	ResultSet rs = pharmacy.viewAllInfo() != null ? pharmacy.viewAllInfo() : null;
	...
	if(session.getAttribute("username")== null) {
		...
		if(request.getParameter("btn") != null && request.getParameter("btn").equals("sign_out_view")) {
...
<body>
			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<ul class="nav navbar-nav">
  					<a class="navbar-brand" href="#">Pharmacy</a>
						  ...
						  <li class="active"><button type="submit" name="btn" value="view">View</button></li>
						  <li><button type="submit" name="btn" value="search">Search</button></li>
 
				</ul>
				<p class="navbar-text navbar-right">
	<button type="submit" class="btn btn-default btn-danger btn-sm" name="btn" value="sign_out_view">Sign Out</button></p>
			</nav>
		<div class="bodyBG">
	...
	<img src="products.png" alt="" >
		...
		<br><br><br>
		<table class="table table-responsive" cellpadding="1" border="4">
