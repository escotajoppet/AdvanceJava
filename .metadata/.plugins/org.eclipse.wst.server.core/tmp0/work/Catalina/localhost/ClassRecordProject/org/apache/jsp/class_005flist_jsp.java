...
public final class class_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(getClassInfo!=null){
      ...
      if (true) {
        _jspx_page_context.forward("AddClass");
        return;
      }
...
for(int i = 0; i<classrecord.getClasses().size(); i++){	
      ...
      out.print(classrecord.getClasses().get(i) );
      out.write("\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"submit\" name=\"getclassinfo\" value=\"");
      out.print(classrecord.getClasses().get(i) );
      out.write(" Students\" class=\"btn btn-success btn-sm buton-class\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(!classrecord.getNumberOfStudents().isEmpty() ? classrecord.getNumberOfStudents().get(i) : 0);
      out.write(" Student(s)</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(newSchedule.contains("/ ") ? newSchedule.replace("/ ", "<br />") : newSchedule );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
}
      ...
      out.write("\t\t\t\t\t<hr />\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" name=\"addnewclass\" value=\"Add New Class\" class=\"btn btn-primary buton\"/>\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" name=\"deleteclass\" value=\"Delete Class\" ");
      out.print(classrecord.getClassRow()==0 ? "DISABLED" : "" );
      out.write(" class=\"btn btn-danger buton\" id=\"btndel\"/>\r\n");
      out.write("\t\t\t\t</form>\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t\r\n");
